...
\includegraphics{r-hypergeometric}
...
```{r echo = FALSE, fig.width=11, fig.height=6, out.width = "0.6\\linewidth", fig.align="center"}
par(mfrow = c(1,2))
...
#### Using R to find gamma probabilities
