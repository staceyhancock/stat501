...
See our [course calendar](calendar.html) for material covered each week. Click the Github icon in the top right of the navigation bar on this page to access the course content repository, which includes .Rmd and pdf files of scaffolded notes, homework assignments, and R examples.
...
3. **Quizzes** (50%): We will have a short (~20 min) in-class quiz every other Wednesday, alternating weeks with homework assignments. 
