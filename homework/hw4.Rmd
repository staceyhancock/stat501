...
Suppose that the compound's selling price depends on its alcohol content. Specifically, if $\frac{1}{3} < x < \frac{2}{3}$, the compound sells for $c_1$ dollars per gallon; otherwise it sells for $c_2$ dollars per gallon.  The production cost is $c_3$ dollars per gallon. Let $Y$ be the profit per gallon.
    ...
    b. Find the expected value of $Y$. Write a sentence interpreting this value in context of the problem.  
    c. Find the standard deviation of $Y$. Write a sentence interpreting this value in context of the problem.
...
for all $t \neq 0$.  
    ...
    b. Use the mgf to find $E(Y)$ and $E(Y^2)$. Then verify your answers using the mean and variance given in the table of common distributions.  
